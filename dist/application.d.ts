...
declare const GithubApiExperimentApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class GithubApiExperimentApplication extends GithubApiExperimentApplication_base {
